...
import main.java.org.zambiesurvival.gui.*;
...
public class TextDecal extends Decal {    
    ...
    public TextDecal(String statement, Location placement) {
        this(statement, 8, placement, Color.BLACK, true);
    }
    
    public TextDecal(String statement, int fontSize, Location placement, boolean renderToRight) {
    ...
    */
    public static class Test extends JPanel{
        public TextDecal pane;
        public TextDecal hitpointSplat;
        public TextDecal ex1;

        
        public Test() {
            pane = new TextDecal("Greetings! Am I the one who knocks? I am the one who knocks!", 12,  new Location(10,10), Color.BLACK, true);
            hitpointSplat = new TextDecal("50",64, new Location(300,300), Color.RED, false);
            ex1 = new TextDecal("Hello friend. I am the one who knocks.",8,  new Location(200,200), null, true);
        }
    ...
    public static void main(String[] args){
        ...
        TextDecal.Test pane = new TextDecal.Test();
